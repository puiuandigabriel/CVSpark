...
export default function BuilderPage() {
  ...
  /* ---- shared updater wrappers (trigger auto-save) ---- */
  const update = <T,>(setter: React.Dispatch<React.SetStateAction<T>>) => {
      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto px-3 py-2 space-y-0.5 scrollbar-thin">
            ...
            <Collapse id="experience">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <GripVertical
                        size={14}
                        className="text-zinc-700 cursor-grab"
                      />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        type="month"
                        className={cn(inputClass, exp.current && "opacity-40")}
                        value={exp.endDate}
              ...
              <button
                ...
                className={cn(
                  btnSmall,
                  "w-full justify-center border border-dashed border-zinc-700 text-zinc-500 hover:border-indigo-500 hover:text-indigo-400 py-2.5"
                )}
              >
                <Plus size={14} />
                Add Experience
              ...
              <button
                onClick={() =>
                  simulateAi("skills", () =>
                    setSkills((p) => [
                      ...p,
                      ...["Docker", "AWS", "GraphQL", "Git", "Agile"].filter(
                        (s) => !p.includes(s)
                      ),
                    ])
                  )
            ...
            <Collapse id="languages">
              {languages.map((lang) => (
                ...
                >
                            ...
                            x.id === lang.id
                              ? {
                                  ...
                                  proficiency: e.target
                                    .value as LanguageEntry["proficiency"],
                                }
                              : x
                          )
                        );
                  ...
                  <button
                    onClick={() => {
                      setLanguages((p) => p.filter((x) => x.id !== lang.id));
                      triggerAutoSave();
                    }}
            ...
            <div className="pt-3 pb-6 px-1">
              <button
                ...
                className={cn(
                  btnSmall,
                  "w-full justify-center border border-dashed border-zinc-700 text-zinc-500 hover:border-indigo-500 hover:text-indigo-400 py-3 rounded-xl"
                )}
              >
                <Plus size={14} />
                Add Custom Section
        ...
        >
          <div className="flex items-start justify-center p-6 lg:p-10 min-h-full">
            <div className="w-full max-w-[210mm] rounded-sm bg-white shadow-2xl shadow-black/50 ring-1 ring-zinc-800/30">
              {/* Paper content */}
              <div className="px-10 py-10 text-zinc-900 min-h-[297mm]">
                ...
                {skills.length > 0 && (
                  <div className="mb-7">
                    <h2 className="text-[10px] font-bold uppercase tracking-[0.2em] text-indigo-600 mb-2.5">
                      Skills
                    </h2>
                    <div className="flex flex-wrap gap-1.5">
                      {skills.map((skill) => (
                        <span
                          key={skill}
                          className="rounded-md bg-indigo-50 px-2.5 py-0.5 text-xs font-medium text-indigo-700 border border-indigo-100"
                        >
                          {skill}
                        </span>
                      ))}
                    ...
                    <div className="space-y-2.5">
                      {languages
                        ...
                        .map((lang) => (
                          ...
                          >
                            <span className="w-24 text-sm text-zinc-700">
                              {lang.name}
                            </span>
                            <div className="flex-1 h-1.5 rounded-full bg-zinc-100 overflow-hidden">
                              <motion.div
                                ...
                                animate={{
                                  width: `${
                                    proficiencyPercent[lang.proficiency] ?? 50
                                  }%`,
                                }}
          ...
          {assistantOpen && (
            ...
            >
              ...
              <div className="border-t border-zinc-800/80 p-3 bg-zinc-900/30">
                <div className="flex gap-2">
                  <input
                    className={cn(inputClass, "flex-1 text-xs py-2.5")}
