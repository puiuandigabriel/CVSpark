...
import { Mail, Lock, User, Loader2, Sparkles, ArrowRight, Eye, EyeOff, Check } from "lucide-react";
      ...
      <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
        ...
        >
          <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/50 backdrop-blur-sm p-8 shadow-2xl shadow-black/50">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-emerald-500/10 border border-emerald-500/20 mx-auto mb-4">
    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
      ...
      >
        ...
        <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/50 backdrop-blur-sm p-8 shadow-2xl shadow-black/50">
          ...
          <p className="text-sm text-zinc-400 text-center mb-7">Start building your professional CV today</p>
